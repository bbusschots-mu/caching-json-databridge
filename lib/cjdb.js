...
class Datasource{
     ...
     * containing multipel callbaacks will be returned.
     * @param {DatabridgeNamne} [...callbackPath] - if arguments are passed,
     * they will be interpreted as paths within the dataFetchers data
     * structure.
